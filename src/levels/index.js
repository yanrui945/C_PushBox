...
export const LEVELS = [
  ...
  // 第18关 - 迷宫探索
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, EMPTY, TARGET, EMPTY, TARGET, WALL],
      [WALL, WALL, BOX, WALL, BOX, WALL, WALL],
      [WALL, EMPTY, EMPTY, PLAYER, EMPTY, EMPTY, WALL],
      [WALL, BOX, WALL, EMPTY, WALL, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第19关 - 通道交错
  {
    ...
    map: [
      ...
      [WALL, BOX, WALL, EMPTY, BOX, WALL, EMPTY, WALL],
  ...
  // 第24关 - 双层通道
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, WALL, TARGET, TARGET, EMPTY, WALL],
      [WALL, EMPTY, BOX, EMPTY, WALL, BOX, WALL],
  ...
  // 第26关 - 双向迷宫
  {
    ...
    map: [
      ...
      [WALL, WALL, EMPTY, PLAYER, EMPTY, EMPTY, WALL, WALL],
  ...
  // 第27关 - 箱子迷阵
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, TARGET, TARGET, TARGET, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, WALL, EMPTY, WALL, EMPTY, EMPTY, WALL],
      [WALL, BOX, BOX, BOX, BOX, WALL, EMPTY, WALL],
  ...
  // 第28关 - 环形迷宫
  {
    ...
    map: [
      ...
      [WALL, EMPTY, WALL, BOX, BOX, WALL, BOX, WALL],
      [WALL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第29关 - 目标围城
  {
    ...
    map: [
      ...
      [WALL, TARGET, EMPTY, BOX, BOX, EMPTY, TARGET, WALL],
  ...
  // 第31关 - 箱子迷宫
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, EMPTY, TARGET, WALL, TARGET, EMPTY, WALL],
  ...
  // 第33关 - 目标迷阵
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, EMPTY, WALL, EMPTY, TARGET, EMPTY, WALL],
      [WALL, WALL, BOX, EMPTY, BOX, WALL, EMPTY, WALL],
      [WALL, TARGET, WALL, PLAYER, WALL, EMPTY, EMPTY, WALL],
  ...
  // 第34关 - 箱子交换
  {
    ...
    map: [
      ...
      [WALL, BOX, BOX, BOX, WALL, EMPTY, WALL],
      [WALL, EMPTY, WALL, PLAYER, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第35关 - 多重障碍
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, WALL, TARGET, EMPTY, WALL, TARGET, WALL],
      [WALL, EMPTY, BOX, EMPTY, WALL, BOX, EMPTY, WALL],
      [WALL, BOX, WALL, EMPTY, EMPTY, WALL, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, PLAYER, WALL, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第36关 - 路径选择
  {
    ...
    map: [
      ...
      [WALL, WALL, BOX, WALL, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, BOX, EMPTY, BOX, WALL, WALL],
      [WALL, PLAYER, WALL, EMPTY, WALL, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第38关 - 空间利用
  {
    ...
    map: [
      ...
      [WALL, TARGET, TARGET, TARGET, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, WALL, EMPTY, WALL, EMPTY, WALL],
      [WALL, BOX, BOX, BOX, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, WALL, PLAYER, WALL, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  ...
  // 第39关 - 迷宫探索
  {
    ...
    map: [
      ...
      [WALL, WALL, BOX, EMPTY, BOX, WALL, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, PLAYER, WALL, EMPTY, EMPTY, WALL],
      [WALL, EMPTY, WALL, BOX, EMPTY, EMPTY, TARGET, WALL],
      [WALL, EMPTY, EMPTY, WALL, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第40关 - 箱子阵型
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, TARGET, TARGET, EMPTY, EMPTY, WALL],
      [WALL, TARGET, WALL, EMPTY, WALL, EMPTY, WALL],
      [WALL, BOX, BOX, BOX, BOX, EMPTY, WALL],
      [WALL, EMPTY, WALL, PLAYER, WALL, EMPTY, WALL],
      [WALL, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL]
...
,
  ...
  // 第42关 - 十字路口
  {
    ...
    map: [
      ...
      [WALL, TARGET, EMPTY, TARGET, TARGET, EMPTY, TARGET, WALL],
      [WALL, EMPTY, WALL, EMPTY, EMPTY, WALL, EMPTY, WALL],
      [WALL, BOX, EMPTY, BOX, BOX, EMPTY, BOX, WALL],
  ...
  // 第43关 - 环形通道
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, EMPTY, TARGET, TARGET, EMPTY, TARGET, WALL],
      [WALL, WALL, WALL, EMPTY, EMPTY, WALL, WALL, WALL],
      [WALL, BOX, EMPTY, BOX, BOX, EMPTY, BOX, WALL],
      [WALL, EMPTY, WALL, PLAYER, EMPTY, WALL, EMPTY, WALL],
      [WALL, EMPTY, WALL, EMPTY, EMPTY, WALL, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
  ...
  // 第44关 - 双向选择
  {
    ...
    map: [
      ...
      [WALL, EMPTY, BOX, EMPTY, EMPTY, BOX, EMPTY, WALL],
      [WALL, WALL, EMPTY, PLAYER, EMPTY, EMPTY, WALL, WALL],
      [WALL, BOX, EMPTY, EMPTY, EMPTY, BOX, EMPTY, WALL],
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL]
    ]
  },
  ...
  // 第45关 - 迷宫交错
  {
    ...
    map: [
      ...
      [WALL, WALL, BOX, WALL, BOX, WALL, BOX, WALL],
  ...
  // 第46关 - 箱子阵列
  {
    ...
    map: [
      ...
      [WALL, EMPTY, WALL, EMPTY, WALL, EMPTY, EMPTY, WALL],
      [WALL, BOX, BOX, BOX, BOX, BOX, EMPTY, WALL],
  ...
  // 第50关 - 大师级
  {
    ...
    map: [
      [WALL, WALL, WALL, WALL, WALL, WALL, WALL, WALL],
      [WALL, TARGET, EMPTY, TARGET, TARGET, EMPTY, TARGET, WALL],
      [WALL, WALL, BOX, WALL, WALL, BOX, WALL, WALL],
